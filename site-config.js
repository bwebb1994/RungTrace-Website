...
window.RUNGTRACE_CONFIG = {
  ...
  legal: {
    ...
    LEGAL_CONTACT_EMAIL: "brady@webbinnovations.com",
    PRIVACY_EMAIL: "brady@webbinnovations.com",
    BILLING_EMAIL: "brady@webbinnovations.com",
    DSR_EMAIL: "brady@webbinnovations.com",
